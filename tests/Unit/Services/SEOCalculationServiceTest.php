...
describe('SEOCalculationService', function () {
    let('service', fn() => new SEOCalculationService());
    let('tenant', fn() => Tenant::factory()->create());
    let('project', fn() => Project::factory()->for($this->tenant)->create());

    describe('calculateVisibilityScore', function () {
        it('returns zero for projects with no keywords', function () {
            $score = $this->service->calculateVisibilityScore($this->project);
            
            expect($score)->toBe(0.0);
        });

        it('returns zero for projects with inactive keywords', function () {
        ...
        it('calculates visibility score correctly for single keyword', function () {
        ...
        it('calculates visibility score for multiple keywords', function () {
        ...
        it('uses default search volume when not provided', function () {
            Keyword::factory()->for($this->project)->for($this->tenant)->create([
                'is_tracking_active' => true,
                'current_position' => 1,
                'search_volume' => null
        ...
        it('ignores keywords without positions', function () {
    ...
    describe('calculateTrafficPotential', function () {
        it('returns empty potential for projects with no keywords', function () {
        ...
        it('calculates traffic potential correctly', function () {
        ...
        it('identifies improvement opportunities', function () {
        ...
        it('sorts improvement opportunities by potential', function () {
    ...
    describe('calculateKeywordDifficulty', function () {
        it('calculates basic difficulty correctly', function () {
        ...
        it('assigns higher difficulty to single word keywords', function () {
        ...
        it('assigns higher difficulty to commercial keywords', function () {
    ...
    describe('calculateSeoRoi', function () {
        it('returns zero ROI for projects without traffic data', function () {
        ...
        it('calculates ROI with current traffic', function () {
    ...
    describe('generateRecommendations', function () {
        it('generates content optimization recommendations for low positions', function () {
        ...
        it('generates CTR optimization recommendations for low CTR', function () {
        ...
        it('generates keyword coverage recommendations', function () {
            $reportData = ['summary' => [
                'ranking_keywords' => 10,
                'total_keywords' => 30
            ]];
        ...
        it('always includes technical SEO recommendations', function () {
    ...
    describe('calculateKeywordTrends', function () {
        it('identifies improving keywords correctly', function () {
            $keyword = Keyword::factory()->for($this->project)->for($this->tenant)->create();
        ...
        it('identifies declining keywords correctly', function () {
            $keyword = Keyword::factory()->for($this->project)->for($this->tenant)->create();
        ...
        it('identifies stable keywords correctly', function () {
            $keyword = Keyword::factory()->for($this->project)->for($this->tenant)->create();
        ...
        it('identifies new and lost rankings', function () {
    ...
    describe('calculateSearchVolumeTrends', function () {
        it('categorizes keywords by search volume correctly', function () {
            $keywords = collect([
        ...
        it('creates volume distribution correctly', function () {
            $keywords = collect([
    ...
    describe('calculateContentOpportunities', function () {
        it('identifies first page opportunities', function () {
        ...
        it('identifies new content opportunities', function () {
        ...
        it('sorts opportunities by traffic potential', function () {
    ...
    describe('Edge Cases and Error Handling', function () {
        ...
        it('handles null search volumes gracefully', function () {
            $keyword = Keyword::factory()->for($this->project)->for($this->tenant)->create([
                'is_tracking_active' => true,
                'current_position' => 5,
                'search_volume' => null
